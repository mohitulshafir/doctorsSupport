            ...
            <div id="content">
                ...
                <div class="container-fluid" id="container-wrapper">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Prescription History</h1>
                        <ol class="breadcrumb">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="table-responsive p-3">
                                    <table class="table align-items-center table-flush" id="dataTable">
                                        ...
                                        <tbody>
                                            @foreach ($prescriptionHistory as $item)
                                                <tr>
                                                    <td>{{ explode(' ', $item->created_at) [0] }}</td>
                                                    <td>{{ $item->docName }}</td>
                                                    <td>
                                                        <form action="{{ route('vPrescription') }}"
                                                            method="post">
                                                            @csrf
                                                    ...
                                                    <td><input type="submit" style="color: white" value="Download" class="btn btn-sm btn-info"></td>
                                                </tr>
                                            @endforeach
